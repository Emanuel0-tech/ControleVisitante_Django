...
class Visitante(models.Model):
    ...
    horario_chegada = models.DateTimeField(verbose_name='Horario de chegada', auto_now_add=True)
    ...
    horario_saida = models.DateTimeField(verbose_name='Horario de saida', auto_now_add=False, blank=True , null=True)
    morador_responsavel = models.CharField(verbose_name='Nome do morador(a) responsavel', max_length=200, blank=False, null=False)
